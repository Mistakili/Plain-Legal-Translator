import { type Document, type InsertDocument, type ChatMessage, type InsertChatMessage, type User, type InsertUser, documents, chatMessages, users } from "@shared/schema";
